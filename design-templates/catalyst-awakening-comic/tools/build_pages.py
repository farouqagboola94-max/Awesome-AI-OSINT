...
def to_subdir(fragment):
    ...
    fragment = fragment.replace("'./assets/", "'../assets/")
    fragment = fragment.replace('(./assets/', '(../assets/')
    # Issue pages take issue.css: styles.css minus the rules that cannot
    # match here. Generated by tools/split_css.py.
    fragment = fragment.replace('"styles.css"', '"../issue.css"')
